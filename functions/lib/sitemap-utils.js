...
export const STATIC_PAGES = [
  ...
  // 「某城市现在几点」长尾页（2026-09-14 补入：此前存在但未提交，属孤岛页）
  { path: '/time-in/new-york', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/tokyo', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/beijing', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/paris', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/dubai', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/singapore', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/sydney', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/los-angeles', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/chicago', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/toronto', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-in/seoul', changefreq: 'monthly', priority: '0.6' },
  // 「A 到 B 时差」长尾页（同上，此前未提交）
  // 注：/time-difference/index 不单独提交，已由 /time-difference/ 覆盖
  { path: '/time-difference/new-york-to-london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/la-to-beijing', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/tokyo-to-new-york', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/paris-to-new-york', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/chicago-to-tokyo', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/dubai-to-los-angeles', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/frankfurt-to-new-york', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/hong-kong-to-los-angeles', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/miami-to-london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/mumbai-to-dubai', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/seoul-to-london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/singapore-to-london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/sydney-to-london', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/sydney-to-new-york', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/toronto-to-shanghai', changefreq: 'monthly', priority: '0.6' },
  { path: '/time-difference/nueva-york-a-londres', changefreq: 'monthly', priority: '0.5' },
  // 中文站名页（覆盖中文搜索「城市A到城市B时差」）。sitemap 规范要求 URL 为
  // percent-encoded，已实测该编码形式在线上返回 200。
  { path: '/time-difference/%E6%B4%9B%E6%9D%89%E7%9F%B6%E5%88%B0%E5%8C%97%E4%BA%AC', changefreq: 'monthly', priority: '0.5' },
  // 辅助页
